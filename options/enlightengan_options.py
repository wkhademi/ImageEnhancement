...
def EnlightenGANOptions(BaseOptions):
    ...
    def __init__(self, training):
        ...
        self.parser.add_argument('--patchD_3', type=int, default=5, help='Choose number of crops for patch discriminator')

        # other arguments
        self.parser.add_argument('--times_residual', action='store_true', help='output = inut + residual*attention')
